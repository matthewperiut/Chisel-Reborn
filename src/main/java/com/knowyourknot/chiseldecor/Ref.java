...
import com.knowyourknot.chiseldecor.config.BlockVariant;
...
public class Ref {
    ...
    public static final ItemGroup ITEM_GROUP = FabricItemGroupBuilder.build(new Identifier(Ref.MOD_ID, "chiselblocks"), () -> new ItemStack(ChiselDecorEntryPoint.ITEM_CHISEL));
    ...
    public static final String MOD_ID = "chiseldecor";

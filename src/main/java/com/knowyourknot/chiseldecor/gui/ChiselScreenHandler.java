...
import com.knowyourknot.chiseldecor.inventory.ChiselInventory;
import com.knowyourknot.chiseldecor.inventory.IInventoryImpl;
...
public class ChiselScreenHandler extends ScreenHandler {
    ...
    public ItemStack transferSlot(PlayerEntity player, int invSlot) {
        ...
        if (slot != null && slot.hasStack()) {
            ...
            if (originalStack.getItem().equals(ChiselDecorEntryPoint.ITEM_CHISEL)) {

...
import com.matthewperiut.chisel.config.BlockVariant;
...
public class Ref {
    ...
    public static final ItemGroup ITEM_GROUP = FabricItemGroupBuilder.build(new Identifier(Ref.MOD_ID, "chisel"), () -> new ItemStack(Chisel.ITEM_CHISEL));
